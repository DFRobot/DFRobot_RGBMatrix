...
static DFRobot_RGBMatrix *activePanel = NULL;

DFRobot_RGBMatrix::DFRobot_RGBMatrix(
...
// Original DFRobot_RGBMatrix library used 3/3/3 color.  Later version used
...
uint16_t DFRobot_RGBMatrix::Color333(uint8_t r, uint8_t g, uint8_t b)
{
	// RRRrrGGGgggBBBbb
...
uint16_t DFRobot_RGBMatrix::Color444(uint8_t r, uint8_t g, uint8_t b)
{
	// RRRRrGGGGggBBBBb
...
uint16_t DFRobot_RGBMatrix::Color888(uint8_t r, uint8_t g, uint8_t b)
{
...
void DFRobot_RGBMatrix::customizeZH(const uint8_t *arr, uint8_t fontSize, uint8_t x, uint8_t y, uint16_t color)
{
...
void DFRobot_RGBMatrix::drawPixel(int16_t x, int16_t y, uint16_t c)
{
...
void DFRobot_RGBMatrix::fillScreen(uint16_t c)
{
...
uint8_t *DFRobot_RGBMatrix::backBuffer()
{
...
void DFRobot_RGBMatrix::swapBuffers(boolean copy)
{
...
void DFRobot_RGBMatrix::dumpMatrix(void)
{
...
void DFRobot_RGBMatrix::updateDisplay(void)
{
